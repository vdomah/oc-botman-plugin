...
class IncomingMessage extends \BotMan\BotMan\Messages\Incoming\IncomingMessage
{
    /** @var string */
    protected $message;
    ...
    public function __construct($message, $sender, $recipient, $payload = null, $id_prefix = '')
    {
    ...
    {
        return 'conversation-'.$this->id_prefix.sha1($this->getSender()).'-'.sha1($this->getRecipient());
    }
